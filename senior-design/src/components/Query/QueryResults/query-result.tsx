    ...
    return (
        ...
        >
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative'}}>
                <Box sx={{ fontSize: '20px', fontWeight: 'bold', position: 'absolute', left: '50%', transform: 'translateX(-50%)'}}>Query Results <IconButton children = {<DownloadIcon/>} sx={{color: 'white' }} onClick={() => downloadData()}/></Box>
